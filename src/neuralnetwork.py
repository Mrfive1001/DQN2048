...
class NeuralNetwork():
            ...
            for i in range(self.num_inputs):
                if not hidden_layer_weights:
                    self.hidden_layer.neurons[
                        h].weights.append(random.random() * 2 - 1)
                else:
            ...
            for h in range(len(self.hidden_layer.neurons)):
                if not output_layer_weights:
                    self.output_layer.neurons[
                        o].weights.append(random.random() * 2 - 1)
                else:
    ...
    def feed_forward(self, inputs):
        # print("Calculate hidden layer:\n")
        hidden_layer_outputs = self.hidden_layer.feed_forward(inputs)
        # print(hidden_layer_outputs)
        # print("Calculate output layer:\n")
        output_layer_outputs = self.output_layer.feed_forward(
            hidden_layer_outputs)
        print("Hidden layer outputs = " + str(hidden_layer_outputs))
        print("Output layer outputs = " + str(output_layer_outputs))
    ...
    def train(self, training_inputs, training_outputs):
        ...
        for h in range(len(self.hidden_layer.neurons)):
            ...
            # ∂E/∂zⱼ = dE/dyⱼ * ∂zⱼ/∂
            pd_errors_wrt_hidden_neuron_total_net_input[
                h] = d_error_wrt_hidden_neuron_output * self.hidden_layer.neurons[h].calculate_pd_total_net_input_wrt_input()
    ...
    def calculate_total_error(self, training_sets):
        ...
        for t in range(len(training_sets)):
            ...
            for o in range(len(training_outputs)):
                total_error += self.output_layer.neurons[
                    o].calculate_error(training_outputs[o])
        return total_error
...
class NeuronLayer():
    ...
    def __init__(self, num_neurons, bias):
        ...
        self.bias = 0.0  # bias if bias else random.random()
        self.neurons = []
